    ...
    <footer className="bg-gray-900 px-20 py-10 text-white">
      <div className="flex md:flex-row flex-col justify-between mx-auto container">
        <div className="mb-6 md:mb-0">
          ...
          <p className="text-gray-400">Connecting volunteers with those in need</p>
        </div>
        <div className="mb-6 md:mb-0">
          ...
          <ul>
            ...
            <li className="mb-1"><a href="/contact" className="hover:text-gray-300">Contact</a></li>
            <li className="mb-1"><a href="/privacy" className="hover:text-gray-300">Privacy Policy</a></li>
        ...
        <div>
          <h3 className="mb-2 font-semibold text-xl">Subscribe to our Newsletter</h3>
          <form>
            <input
              type="email"
            ...
            />
            <button type="submit" className="block bg-blue-500 hover:bg-blue-600 py-2 rounded-md w-full text-white">
              Subscribe
            </button>
          </form>
        </div>
